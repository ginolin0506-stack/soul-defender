...
export class Tutorial {
  constructor(enabled) {
    ...
    this.steps = {
      start: { text: DEVICE_PROFILE.hud.tutorialStart, life: 11 },
      ...
      lancer: { text: '突刺兵：靠近後紅線預警 0.6 秒 → 直線衝刺 12 單位。看到紅線就點一下閃側邊！', life: 10 },
      ...
      sentinel: { text: '哨衛：超慢但 480 HP 硬如石頭。短點朝它衝刺能咬下 45 HP，搭配脈衝。不打掉就是撞水晶 55 傷害。', life: 11 },
